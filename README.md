...
- Mais tempo para focar no mais importante: regras de nogócio e experiência do usuário
...
- Utiliza o Node.js 
- Permetide a configuração rápida e fácil de ambientes e plugins Node
